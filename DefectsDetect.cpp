...
int DefectsDetect::run_rujie(HObject ho_Image, HObject deal_image, const int width, const int height, const Hlong &winid)
{
    ...
    HObject  ho_ImageResult, ho_Rectangle1, ho_ImageReduced1;
    HObject  ho_Image2, ho_Rectangle2, ho_ImageReduced2, ho_Regions;
    ...
    HTuple  hv_Result, hv_ImageFiles1, hv_Index1, hv_WindowHandle1;
    ...
    HTuple  hv_FeatureVector1, hv_ImageFiles2, hv_Width2, hv_Height2;
    HTuple  hv_Result2, hv_Error, hv_ErrorLog, hv_FileHandle;
    HTuple  hv_WindowHandle2, hv_Value, hv_Class112, hv_Energy2;
    HTuple  hv_Correlation2, hv_Homogeneity2, hv_Contrast2;
    ...
    if (0 != hv_test)
    {
        ReadClassMlp("D:/StickDetect01.gmc", &hv_MLPHandle);
        {
            ...
            Threshold(ho_ImageResult, &ho_Regions, 40, 255);

            GenRectangle1(&ho_Rectangle, 1, 5, hv_Height2-2, hv_Width2-10);
